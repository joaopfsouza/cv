...
#show: rendercv.with(
  ...
  top-note: [ #emph[Última atualização Jul 2026] ],
...
= João Paulo Ferreira de Souza
  ...
  #headline([DevOps Engineer | Kubernetes | Terraform | Azure | AWS | Python | Certified: 3x Azure])
...
#strong[Cloud & IaC]: Especialista em ecossistema Azure, com experiência em provisionamento padronizado via Terraform, Bicep e ARM Templates.

#strong[CI\/CD & Automação]: Implementação de pipelines em larga escala com Azure DevOps, GitHub Actions e GitLab CI\/CD. Automação com Python, PowerShell e Shell Script.

#strong[DevSecOps & Qualidade]: Integração de segurança nas esteiras de deploy (SAST\/DAST e SonarQube). Apoio técnico em conformidade e adequação PCI DSS para ambientes críticos.

#strong[Gestão Operacional & Agilidade]: Sustentação de ambientes produtivos, observabilidade e governança baseada em ITIL para cumprimento de SLAs e melhoria contínua.

#strong[Certificações Microsoft]: DevOps Engineer Expert (AZ-400) · Azure Administrator Associate (AZ-104) · Azure Fundamentals (AZ-900)
